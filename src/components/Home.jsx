  ...
  return (
    <div className="bg-pink-50 min-h-screen p-6">
      ...
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore a variety of personalized cards for weddings, birthdays, vastu, and more at S.K Cards. Browse our extensive collection of beautifully designed cards."
        />
